          ...
          <div class="row">
              ...
              <table class="table table-bordered" >
                  <tr>
                      ...
                      <td colspan="6"><center>View Replys</center></td>
                  </tr>
                  <tr class="success">
                     
                      <th>sno</td><th>FId</th><th>Asked For</th><th>Reply</th><th>PostDate</th><th>ReplyDate</th>
                  ...
                  <tr class="danger">
                        ...
                        Connection con=  dbconn.getconn();
                          PreparedStatement pst=con.prepareStatement("select * from qsns where sid='"+sid+"'");
                          ...
                          while(rs.next()){
                             ...
                             cnt=cnt+1;
                              ...
                              <td><%=cnt%></td> <td><%=rs.getString("fid")%></td> <td><%=rs.getString("qsn")%></td> <td><%=rs.getString("answer")%></td> <td><%=rs.getString("pdate")%></td> <td><%=rs.getString("rdate")%></td>
